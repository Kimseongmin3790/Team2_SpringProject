...
- **구현 기능:**
    ...
    CSS, 유효성 검사, 로그인 기능, 아이디/비밀번호 찾기, 정보 조회, 정보 수정, 프로필 사진 업로드 기능 구현
...
- **구현 기능:**
    ...
    상품 썸네일, 상세 이미지 멀티 업로드 기능, 장바구니 조회, 주문 정보 조회
...
* 발표 PPT: [https://drive.google.com/file/d/1uDGNjkepO-dKUQeIpOhPxPQ-29l4lkpr/view?usp=drive_link](ppt보기)
* 시연 영상: [링크]()
