                    ...
                    <main class="content">
                        <div class="find-container">
                            ...
                            <div v-if="step === 2">
                                ...
                                <button class="btn btn-secondary" style="margin-top:10px;" @click="goBack">←
                                    돌아가기</button>
                ...
                const app = Vue.createApp({
                    ...
                    methods: {
                        ...
                        fnSendEmail() {
                            ...
                            $.ajax({
                                url: self.path + "/findPwdSendCode.dox",
                                dataType: "json",
                                type: "POST",
                                data: param,
                                success: (data) => {
                                    if (data.result === "success") {
                                        ...
                                        self.notFound = false;
                                        self.step = 2;
                                        swSuccess("발송 완료", "인증코드가 이메일로 전송되었습니다.");
                                    } else {
                                        self.emailSent = false;
                                        self.notFound = true;
                                        swWarn("일치하는 회원정보가 없습니다.");
                                    }
                                },
                                error: () => {
                        ...
                        fnResetPwd() {
                            ...
                            $.ajax({
                                url: self.path + "/findPwdReset.dox",
                                dataType: "json",
                                type: "POST",
                                data: param,
                                success: (data) => {
                                    if (data.result === "success") {
                                        ...
                                        swSuccess("변경 완료", "비밀번호가 성공적으로 변경되었습니다.").then(() => {
                                            // 필요하면 바로 로그인 페이지로 이동
