...
<head>
    ...
    <style>
        /* 기본 레이아웃 */
        html, body { 
            margin:0; height:100%; font-family: 'Noto Sans', sans-serif; 
        }
        #app { min-height:100vh; display:flex; flex-direction:column; }
        main.content { flex:1; padding:2rem; }

        /* 헤더 */
        header { border-bottom:1px solid #e5e7eb; background:white; }
        header h1 { font-size:1.5rem; font-weight:bold; color:#059669; }
        header .btn { padding:0.25rem 0.5rem; border:1px solid #d1d5db; border-radius:0.375rem; background:white; cursor:pointer; }

        /* 사용자 배너 */
        .user-banner { padding:1.5rem; margin-bottom:2rem; border-radius:0.5rem; background:linear-gradient(to right, #ecfdf5, #d1fae5); display:flex; gap:1rem; align-items:center; }
        .user-initial { width:4rem; height:4rem; background:#10b981; border-radius:9999px; display:flex; align-items:center; justify-content:center; color:white; font-size:1.5rem; font-weight:bold; }
        .user-info h2 { font-size:1.25rem; font-weight:bold; }
        .user-info p { font-size:0.875rem; color:#6b7280; }

        /* 카드 */
        .card { padding:1rem; border-radius:0.5rem; border:1px solid #e5e7eb; background:white; }
        ...
        /* 탭 */
        .tabs-list { display:grid; grid-template-columns:repeat(4,1fr); border-bottom:1px solid #e5e7eb; margin-bottom:2rem; }
        .tabs-list button { padding:0.5rem 1rem; text-center; background:none; border:none; cursor:pointer; font-weight:500; }
        .tabs-list button.active { border-bottom:2px solid #10b981; font-weight:bold; }

        /* Footer */
        footer { border-top:1px solid #d1d5db; background:#f3f4f6; padding:2rem; text-align:center; font-size:0.875rem; color:#6b7280; }
...
<div id="app">
    ...
    <header class="container mx-auto px-4 py-4 flex justify-between items-center">
        <h1>농수산물 직거래 장터</h1>
        <button class="btn btn-outline">로그아웃</button>
    </header>
    ...
    <!-- Footer -->
    <footer>
        © 2025 농수산물 직거래 장터. All rights reserved.
    </footer>
</div>
</body>
</html>
