 <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <div class="section-intro">
        <p>**사이트(주) 회사**(이하 **‘회사’**라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.</p>
    </div>
    ...
    <ol>
        <li>
            <h3>AGRICOLA 회원 가입 및 관리</h3>
            <p>회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, **AGRICOLA 서비스** 부정 이용 방지, 만 14세 미만 아동의 개인정보처리 시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등을 목적으로 개인정보를 처리합니다.</p>
        </li>
        <li>
            <h3>재화 또는 서비스 제공</h3>
            <p>물품 배송, 서비스 제공, 계약서 및 청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등을 목적으로 개인정보를 처리합니다.</p>
        </li>
        <li>
            <h3>고충 처리</h3>
    ...
    <dl>
        <dt>1. AGRICOLA 회원 가입 및 관리 :</dt>
        <dd>몰 탈퇴 시까지</dd>
        <dd class="note">다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지
            <ul>
                <li>1) 관계 법령 위반에 따른 수사, 조사 등이 진행 중인 경우에는 해당 수사, 조사 종료 시까지</li>
                <li>2) 몰 이용에 따른 채권 및 채무관계 잔존 시에는 해당 채권, 채무 관계 정산 시까지</li>
            </ul>
        </dd>
        <dt>2. 재화 또는 서비스 제공 :</dt>
        <dd>재화․서비스 공급완료 및 요금결제․정산 완료 시까지</dd>
        <dd class="note">다만, 다음의 사유에 해당하는 경우에는 해당 기간 종료 시까지
            <ul>
    ...
    <p>② 회사는 원활한 서비스 제공을 위해 다음의 경우 개인정보보호법 제17조 제1항 제1호에 따라 정보주체의 동의를 얻어 필요 최소한의 범위로만 개인정보를 제3자에게 제공할 수 있습니다.</p>
    <ul style="list-style-type: none;">
        <li>- 개인정보를 제공받는 자 : &lt;예) (주) OOO 카드&gt;</li>
        <li>- 제공받는 자의 개인정보 이용목적 : &lt;예) 이벤트 공동개최 등 업무제휴 및 제휴 신용카드 발급&gt;</li>
        <li>- 제공하는 개인정보 항목 : &lt;예) 성명, 주소, 전화번호, 이메일주소, 카드결제계좌정보&gt;</li>
        <li>- 제공받는 자의 보유, 이용기간 : &lt;예) 신용카드 발급계약에 따른 거래기간동안&gt;</li>
    </ul>
    ...
    <h2>제5조(정보주체 및 법정대리인의 권리와 그 행사 방법)</h2>
    ...
    <p>⑤ 정보주체는 개인정보 보호법 등 관계 법령을 위반하여 회사가 처리하고 있는 정보주체 본인이나 타인의 개인정보 및 사생활을 침해하여서는 아니 됩니다.</p>
    ...
    <dl>
        ...
        <dd>
            <ul>
                <li>**필수항목** : ID, 성명, 비밀번호, 주소, 휴대폰 번호, 이메일, 14세 미만 가입자의 경우 법정대리인 정보, 생년월일, 암호화된 이용자 확인값(CI)</li>
                <li>**선택항목** : 결혼 여부, 관심 분야</li>
            </ul>
        </dd>
        <dt>2. 재화 또는 서비스 제공</dt>
        <dd>
            <ul>
                <li>**필수항목** : 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보</li>
                <li>**선택항목** : 과거 구매내역</li>
            </ul>
        </dd>
    </dl>
    ...
    <p>④ 회사는 서비스 이용과정에서 사용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 수집・이용하고 있습니다.</p>
    ...
    <div class="contact-info">
        <p><strong>성명</strong> : OOO</p>
        <p><strong>직책</strong> : 팀장</p>
        <p><strong>연락처</strong> : &lt;1234-5678&gt;, &lt;010-000-0000&gt;</p>
        <p class="note">※ 개인정보 보호 담당부서로 연결됩니다.</p>
    </div>

    <h3>▶ 개인정보 보호 담당부서</h3>
    <div class="contact-info">
        <p><strong>부서명</strong> : 마케팅 팀</p>
        <p><strong>연락처</strong> : &lt;1234-5678&gt;, &lt;010-000-0000&gt;</p>
    </div>
    ...
    <ol>
        <li>개인정보 분쟁조정위원회 : (국번없이) 1833-6972 (<a href="www.kopico.go.kr">www.kopico.go.kr</a>)</li>
        <li>개인정보침해신고센터 : (국번없이) 118 (<a href="privacy.kisa.or.kr">privacy.kisa.or.kr</a>)</li>
        <li>대검찰청 : (국번없이) 1301 (<a href="www.spo.go.kr">www.spo.go.kr</a>)</li>
        <li>경찰청 : (국번없이) 182 (<a href="ecrm.police.go.kr/minwon/main">ecrm.police.go.kr/minwon/main</a>)</li>
    </ol>

    <hr>

    <h2>제13조(개인정보 처리방침 시행 및 변경)</h2>
    <p>이 개인정보 처리방침은 **2025. 5. 15. 부터 적용**됩니다.</p>