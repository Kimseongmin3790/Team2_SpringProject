                ...
                <main class="container main-content">
                    <div class="max-w-5xl mx-auto">
                        ...
                        <div class="service-card-grid">
                            <div class="service-card" @click="activeTab = 'faq'"
                        ...
                        <div v-if="activeTab === 'faq'" class="content-section">
                            ...
                            <div class="faq-list">
                                <details>
                                    <summary class="faq-question"><span class="faq-question-text">[배송관련]배송은
                                            얼마나걸리나요?</span><span class="faq-arrow">▼</span></summary>
                                    <div class="faq-answer">주문 후 2-3일 이내에 배송됩니다. 신선 상품의 경우당일 또는 익일 배송이 가능합니다.</div>
                                </details>
                                <details>
                                    <summary class="faq-question"><span class="faq-question-text">[주문결제]결제 방법은어떤 것이
                                            있나요?</span><span class="faq-arrow">▼</span></summary>
                                    <div class="faq-answer">신용카드, 계좌이체, 무통장입금, 간편결제(카카오페이,네이버페이) 등을 지원합니다.</div>
                                </details>
                                <details>
                                    <summary class="faq-question"><span class="faq-question-text">[상품관련] 사진하고
                                            달라요.</span><span class="faq-arrow">▼</span></summary>
                                    <div class="faq-answer">농산물의 경우 공산품처럼 상품이 항상 같을 수가 없습니다.이점 양해 부탁드립니다</div>
                                </details>
                                <details>
                                    <summary class="faq-question"><span class="faq-question-text">[계정관련] 탈퇴는 어떻게
                                            하나요?</span><span class="faq-arrow">▼</span></summary>
                                    <div class="faq-answer">상단의 마이페이지 -> 내 정보 관리 탭에서 회원 탈퇴 하실 수 있습니다</div>
                                </details>
                                <details>
                                    <summary class="faq-question"><span class="faq-question-text">[기타] 판매자에게 상품 문의를 하고
                                            싶어요</span><span class="faq-arrow">▼</span></summary>
                        ...
                        <div v-if="activeTab === 'inquiry'" class="content-section inquiry-form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inquiry-content" class="form-textarea" placeholder="문의하실 내용을 입력하세요"
                                    v-model="inquiryContent"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="inquiry-password">비밀번호</label>
                                <input type="password" id="inquiry-password" class="form-input"
                                    placeholder="비밀번호를 입력하세요. (최대 20자)" v-model="inquiryPassword" maxlength="20">
                            </div>
                            ...
                            <div class="notice-list">
                                ...
                                <div v-for="notice in latestNotices" :key="notice.noticeNo" class="notice-item">
                                    <a :href="'/noticeView.do?noticeNo=' + notice.noticeNo" class="notice-title">
                                        {{ notice.title }}
                                        <span v-if="notice.commentCount > 0"
                                            class="comment-count-badge">({{notice.commentCount}})</span>
                                    </a>
