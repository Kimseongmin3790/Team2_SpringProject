                    ...
                    <div class="page-container">
                        <div class="notice-detail-container">
                            ...
                            <div class="notice-actions">
                                ...
                                <button v-if="sessionId === notice.userId || userRole === 'ADMIN'" class="btn-edit"
                                    @click="fnEditNotice(notice.noticeNo)">수정</button>
                                <button v-if="sessionId === notice.userId || userRole === 'ADMIN'" class="btn-delete"
                                    @click="fnDeleteNotice(notice.noticeNo)">삭제</button>
                            </div>
                            ...
                            <div class="comment-section">
                                ...
                                <div class="comment-list">
                                    ...
                                    <div v-for="comment in comments" :key="comment.commentNo" class="comment-item"
                                        :style="{marginLeft: (comment.level - 1) * 40 + 'px'}">
                                        ...
                                        <div class="comment-actions">
                                            <button v-if="sessionId"
                                                @click="fnShowReplyForm(comment.commentNo)">답글</button>
                                            <button v-if="sessionId === comment.userId"
                                                @click="fnEditComment(comment.commentNo)">수정</button>
                                            <button v-if="sessionId === comment.userId || userRole === 'ADMIN'"
                                                @click="fnDeleteComment(comment.commentNo)">삭제</button>
                                        </div>

                                        <div v-if="sessionId && replyFormTarget === comment.commentNo"
                ...
                methods: {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.result === 'success') {
                                    ...
                                    Swal.fire("오류", "공지사항을 불러오는 데 실패했습니다.", "error");
                                }
                            }
                        });
                    },
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.result === "success") {
                                    ...
                                    Swal.fire("오류", "댓글을 불러오는 데 실패했습니다: " + res.message, "error");
                                }
                            },
                            error: function () {
                    ...
                    fnSaveComment: function (parentCommentNo) {
                        ...
                        if (!commentContent.trim()) {
                            Swal.fire("입력 필요", "댓글 내용을 입력해주세요.", "warning");
                            return;
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.result === "success") {
                                    Swal.fire("완료", "댓글이 등록되었습니다.", "success");
                                    ...
                                    Swal.fire("실패", "댓글 등록 실패: " + res.message, "error");
                                }
                            },
                    ...
                    fnUpdateComment: function (commentNo) {
                        ...
                        if (!self.editedCommentContent.trim()) {
                            Swal.fire("입력 필요", "수정할 내용을 입력해주세요.", "warning");
                            return;
                        }
                        ...
                        Swal.fire({
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    if (res.result === "success") {
                                        Swal.fire("완료", "댓글이 수정되었습니다.", "success");
                                        self.fnLoadComments();
                                        self.fnCancelEdit();
                                    } else {
                                        Swal.fire("실패", "댓글 수정 실패: " + res.message, "error");
                                    }
                                },
                                error: function () {
                                    Swal.fire("오류", "서버와의 통신 중 오류가 발생했습니다.", "error");
                    ...
                    fnDeleteComment: function (commentNo) {
                        ...
                        Swal.fire({
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    if (res.result === "success") {
                                        Swal.fire("완료", "댓글이 삭제되었습니다.", "success");
                                        self.fnLoadComments();
                                    } else {
                                        Swal.fire("실패", "댓글 삭제 실패: " + res.message, "error");
                                    }
                                },
                                error: function () {
                                    Swal.fire("오류", "서버와의 통신 중 오류가 발생했습니다.", "error");
