                    ...
                    <main class="content">
                        <div class="edit-container" v-if="inquiry">
                            ...
                            <div class="form-group">
                                ...
                                <input v-if="isSecret" type="password" v-model="inquiry.password"
                            ...
                            methods: {
                                fnLoadDetail() {
                                    $.ajax({
                                        ...
                                        error: () => Swal.fire("오류", "데이터를 불러오는 중 오류가 발생했습니다.", "error")
                                    });
                                },
                                ...
                                fnUpdateInquiry() {
                                    ...
                                    if (!this.inquiry.content.trim()) {
                                        Swal.fire("입력 필요", "내용을 입력하세요.", "warning");
                                        return;
                                    }
                                    if (this.isSecret && !this.inquiry.password) {
                                        Swal.fire("입력 필요", "비공개 설정 시 비밀번호를 입력하세요.", "warning");
                                        return;
                                    }
