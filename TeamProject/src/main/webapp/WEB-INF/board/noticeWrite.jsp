                            ...
                            <div class="edit-form-container">
                                <form id="writeForm">
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn-save" @click="fnSaveNotice">작성</button>
                            ...
                            const app = Vue.createApp({
                                ...
                                methods: {
                                    fnSaveNotice() {
                                        let self = this;
                                        if (!self.title.trim()) {
                                            Swal.fire("입력 필요", "제목을 입력해주세요.", "warning");
                                            return;
                                        }
                                        if (!self.quillEditor.root.innerHTML.trim() || self.quillEditor.root.innerHTML === "<p><br></p>") {
                                            Swal.fire("입력 필요", "내용을 입력해주세요.", "warning");
                                            return;
                                        }
                                        ...
                                        Swal.fire({
                                            ...
                                            const noticeData = {
                                                title: self.title,
                                                contents: self.quillEditor.root.innerHTML
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (res) {
                                                    if (res.result === "success") {
                                                        Swal.fire("완료", "공지사항이 성공적으로 작성되었습니다.", "success");
                                                        location.href = "/board.do?tab=notice";
                                                    } else {
                                                        Swal.fire("오류", "공지사항 작성 중 오류가 발생했습니다: " + res.message, "error");
                                                    }
                                                },
                                                error: function () {
