                        ...
                        <div class="review-card">
                            <div class="form-section">
                                ...
                                <div class="rating-container">
                                    <button v-for="star in 5" :key="star" class="star-button" @click="rating = star"
                                        @mouseenter="hoverRating = star" @mouseleave="hoverRating = 0">
                                        <svg class="star-icon" :class="{ filled: star <= (hoverRating || rating) }"
                            ...
                            <div class="form-section">
                                ...
                                <textarea v-model="content" class="review-textarea"
                                    placeholder="상품에 대한 솔직한 리뷰를 작성해주세요. (최소 10자 이상)" maxlength="500"></textarea>
                            ...
                            <div class="form-section">
                                ...
                                <div class="image-grid">
                                    <div v-for="(image, index) in images" :key="'old-'+image.imageNo"
                                        class="image-item">
                                        <img :src="image.imageUrl" class="image-preview"
                                    ...
                                    <div v-for="(item, index) in newImageFiles" :key="'new-'+index" class="image-item">
                                        <img :src="item.previewUrl" class="image-preview"
                                            style="width:100%; height:100%; object-fit:cover;">
                            ...
                            <div class="action-buttons">
                                ...
                                <button class="btn btn-submit" :disabled="!canSubmit" @click="submitReview">
                                    리뷰 수정
                                </button>
                            </div>
                        </div>
            ...
            const app = Vue.createApp({
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.result === "success" && response.data) {
                                    ...
                                    Swal.fire("실패", "리뷰 정보를 불러오는 데 실패했습니다.", "error");
                                    window.location.href = '${pageContext.request.contextPath}/buyerMyPage.do?tab=reviews';
                                }
                            },
                            error: function () {
                                Swal.fire("오류", "리뷰 정보 조회 중 오류가 발생했습니다.", "error");
                                window.location.href = '${pageContext.request.contextPath}/buyerMyPage.do?tab=reviews';
                            }
                        });
                    },
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.result === "success") {
                                    ...
                                    Swal.fire("실패", "상품 정보를 불러오는 데 실패했습니다.", "error");
                                }
                            },
                            error: function (xhr, status, error) {
                                Swal.fire("오류", "상품 정보 조회 중 오류가 발생했습니다.", "error");
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.result === "success") {
                                    Swal.fire("완료", "리뷰가 수정되었습니다.", "success");
                                    window.location.href = '${pageContext.request.contextPath}/buyerMyPage.do?tab=reviews';
                                } else {
                                    Swal.fire("실패", "리뷰 수정에 실패했습니다: " + data.message, "error");
                                }
                            },
                            error: function (xhr, status, error) {
                                Swal.fire("오류", "리뷰 수정 중 오류가 발생했습니다", "error");
                                console.error('Error:', error);
                            }
                        });
                    },
                ...
                mounted() {
                    ...
                    if (self.reviewNo) {
                        ...
                        Swal.fire("오류", "수정할 리뷰 번호가 없습니다.", "error");
                        window.location.href = '${pageContext.request.contextPath}/buyerMyPage.do?tab=reviews';
                    }
                }
            });
