...
public class SmsController {
    ...
    public SmsController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSJM1MU2LYUC95P", "EACEFNJIWJ0Z3GGFCTLUG7WUIMAJLS8C", "https://api.coolsms.co.kr");
    }
    ...
    public HashMap<String, Object> sendOne(HashMap<String, Object> map) {
        Message message = new Message();
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        String ranStr = randomNumber();
        message.setFrom("01040543790");
        message.setTo((String)map.get("userPhone"));
